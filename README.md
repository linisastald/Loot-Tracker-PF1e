...
| Loot Update             | High     | To Do              |                                                                      |
| Item DB                 | Med      | In Progress        | Have the items mostly, need to design tables and insert              |
| Kept Loot View          | Med      | To Do              |                                                                      |
| Party Kept Loot         | Med      | To Do              |                                                                      |
| Sold View               | Med      | To Do              |                                                                      |
| Campaign Settings       | Med      | Pending            |                                                                      |
| DM Pages                | Med      | Pending            |                                                                      |
| User Settings           | Low      | In Progress        |                                                                      |
| Given Away/Trash View   | Low      | To Do              |                                                                      |
| Session Tracking        | Low      | Pending            |                                                                      |
| GPT to Break items down | Low      | Pending            |                                                                      |
